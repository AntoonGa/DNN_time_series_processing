...
@author: grab
Train unity on FM data.
Vary beta to see effect of bias during training.
This take a while since we train multiple models.
"""
# -*- coding: utf-8 -*-
...
epochs = 1
# betaTags = [ ,, , , ,,]
betaTags = [0.005, 0.004, 0.003, 0.002, 0.001]
# data Folders
dataFolder = r"../data\Storage\00_AMFM_Randomized_1e5Batches/"
# AMFM tags
AMFMtag = "AMFM_varyBeta"
