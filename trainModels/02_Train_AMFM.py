...
for betaTag in betaTags:
    for latentDim in latentDims:
        ...
        dirModels2 = r"./trainModels\1610562995_TrainedModels_Latent5/"
        # SAVE MODEL dirs
        dirSaveModels = r"./" + timeStamp + "_TrainedModels_Latent" + str(latentDim) + "/"
        # SAVING TAGS
        trainTag0 = "-train_Beta0.001_AMFM_10x20x1_8bs-"
        trainTag1 = (
            "-train_Beta"
            + str(betaTag)
            + "_"
        ...
        unity = keras.models.load_model(dirModels2 + uniName + ".keras", compile=False)
